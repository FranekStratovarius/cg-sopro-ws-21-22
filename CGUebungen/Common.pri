...
LIBS += -L$${SGFRAMEWORKPATH} -lSGFrameworkLib

win32:!win32-g++: PRE_TARGETDEPS += $${SGFRAMEWORKPATH}/SGFrameworkLib.lib
else:unix|win32-g++: PRE_TARGETDEPS += $${SGFRAMEWORKPATH}/libSGFrameworkLib.a

#Für OpenAL 3D-Sound
win32-g++: LIBS += -L$$PWD/AudioPackage/OpenALSoft/libs/Win64 -lOpenAL32
