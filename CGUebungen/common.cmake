...
function(setup_project projectname)
	...
	#extra
    file(GLOB_RECURSE src_project_my "${PROJECT_SOURCE_DIR}/*.cpp")
	#extra
    list(FILTER src_project_my EXCLUDE REGEX ".*/build.*")
	...
	#extra
    message("src_project_my: ${src_project_my}")
	...
	#extra erweitert um ${src_project_my}
    add_executable(${projectname} ${src_project} ${src_project_my} ${headerpp_project}  ${header_project} ${uifiles} ${qrcfiles} ${uiproject})
