...
void RenderingContext::setUniforms(QOpenGLShaderProgram* s)
{
    ...
    shaderProgram.setUniformValue("sunLightCount", (int) mActiveSunLights.size());
    shaderProgram.setUniformValue("pointLightCount", (int) mActivePointLights.size());
    shaderProgram.setUniformValue("spotLightCount", (int) mActiveSpotLights.size());
}
